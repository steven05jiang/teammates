...
function prepareTimeZoneInput() {
    ...
    $selectElement.selectize({ selectOnTab: true });
}
...
function verifyCourseData() {
    ...
    var allErrorMessage = checkAddCourseParam(courseID, courseName, courseTimeZone);
...
function checkAddCourseParam(courseId, courseName, courseTimeZone) {
    var errorMessages = getCourseIdInvalidityInfo(courseId);
...
function getCourseIdInvalidityInfo(courseIdParam) {
    
    var invalidityInfo = '';
    
    var courseId = courseIdParam.trim();
...
function getCourseNameInvalidityInfo(courseNameParam) {
    
    var courseName = courseNameParam.trim();
