...
public class FeedbackQuestionFeedbackPathSettings {
    ...
    public void setCustomFeedbackPathsSpreadsheetData(List<FeedbackPathAttributes> feedbackPathsAttributesList) {
        List<List<String>> customFeedbackPaths = new ArrayList<List<String>>();
        for (FeedbackPathAttributes feedbackPathAttributes : feedbackPathsAttributesList) {
